...
​ SpringCloud组件之一：Eureka注册中心，相当于内容分发中心，集中式分发和管理服务。
...
![11](https://gitee.com/ichensw/drawing-bed/raw/master/image/11.png)
...
### 	1.3 修改引导类，在类上添加@EnableEurekaServer注解：
...
​	特别注意：当spring-boot的版本为2.0.x时，SpringCloud使用地铁名版本号，当版本为2.4.x以上时，使用
...
![12](https://gitee.com/ichensw/drawing-bed/raw/master/image/12.png)
...
### 	3.4 修改UserController代码，用DiscoveryClient类的方法，根据服务名称，获取服务实例：
...
![13](https://gitee.com/ichensw/drawing-bed/raw/master/image/13.png)

生成的URL：

![14](https://gitee.com/ichensw/drawing-bed/raw/master/image/14.png)

访问结果：

![15](https://gitee.com/ichensw/drawing-bed/raw/master/image/15.png)

## 4.  搭建EurekaServer集群

​	例如有两个EurekaServer服务，此时Eureka1端口为：10087，Eureka2端口为：10086，则将Eureka1的defaultZone地址指向Eureka2(http://localhost:10086/eureka)，将Eureka2指向Eureka1(http://localhost:10087/eureka)。

​	两个Eureka服务启动时则会相互指向对方的地址，建立起连接。此时将会同时建立两个服务，就算一个挂掉，另一个也可以接着使用，并且数据都是同步的。

```
Application	AMIs	Availability Zones	Status
ITCAST-EUREKA		n/a (2)	(2)	UP (2) - 192.168.1.107:itcast-eureka:10086 , 192.168.1.107:itcast-eureka:10087
SERVICE-CONSUMER	n/a (1)	(1)	UP (1) - 192.168.1.107:service-consumer:80
SERVICE-PROVIDER	n/a (1)	(1)	UP (1) - 192.168.1.107:service-provider:8081
```
...
![16](https://gitee.com/ichensw/drawing-bed/raw/master/image/16.png)
...
![17](https://gitee.com/ichensw/drawing-bed/raw/master/image/17.png)

![18](https://gitee.com/ichensw/drawing-bed/raw/master/image/18.png)

![19](https://gitee.com/ichensw/drawing-bed/raw/master/image/19.png)

然后启动即可。

3）访问集群，测试：

![20](https://gitee.com/ichensw/drawing-bed/raw/master/image/20.png)
...
![21](https://gitee.com/ichensw/drawing-bed/raw/master/image/21.png)

10087：

![22](https://gitee.com/ichensw/drawing-bed/raw/master/image/22.png)
...
![23](https://gitee.com/ichensw/drawing-bed/raw/master/image/23.png)
...
![24](https://gitee.com/ichensw/drawing-bed/raw/master/image/24.png)
