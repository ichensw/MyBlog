...
​   SpringCloud组件之一：Hystrix安全措施，相当于电路的熔断器，当线路短路时，立即切断服务，进入关闭状态。此组件关注点为三种状态：Closed：关闭状态、Open：打开状态、Half Open：半开状态，理解这三种状态即可玩转Hystrix。
...
![38](https://gitee.com/ichensw/drawing-bed/raw/master/image/38.png)
...
微服务中，服务间调用关系错综复杂，一个请求，可能需要调用多个微服务接口才能实现，会形成非常复杂的调用链路：
 ...
 ![39](https://gitee.com/ichensw/drawing-bed/raw/master/image/39.png)

如图，一次业务请求，需要调用A、P、H、I四个服务，这四个服务又可能调用其它服务。

如果此时，某个服务出现异常：

 ![40](https://gitee.com/ichensw/drawing-bed/raw/master/image/40.png)

例如微服务I发生异常，请求阻塞，用户不会得到响应，则tomcat的这个线程不会释放，于是越来越多的用户请求到来，越来越多的线程会阻塞：

 ![41](https://gitee.com/ichensw/drawing-bed/raw/master/image/41.png)
...
线程隔离示意图：
 ...
 ![42](https://gitee.com/ichensw/drawing-bed/raw/master/image/42.png)
...
首先在消费方itcast-service-consumer的pom.xml中引入Hystrix依赖：
...
![43](https://gitee.com/ichensw/drawing-bed/raw/master/image/43.png)

可以看到，我们类上的注解越来越多，在微服务中，经常会引入上面的三个注解，于是Spring就提供了一个组合注解：@SpringCloudApplication

![44](https://gitee.com/ichensw/drawing-bed/raw/master/image/44.png)
...
![45](https://gitee.com/ichensw/drawing-bed/raw/master/image/45.png)
...
![46](https://gitee.com/ichensw/drawing-bed/raw/master/image/46.png)
...
![47](https://gitee.com/ichensw/drawing-bed/raw/master/image/47.png)
...
当我们疯狂访问id为1的请求时（失败比例超过50%以上或超过20次以上），就会触发熔断。断路器会断开，一切请求都会被降级处理。

此时你访问id为2的请求，会发现返回的也是失败，而且失败时间很短，只有几毫秒左右：

![48](https://gitee.com/ichensw/drawing-bed/raw/master/image/48.png)
