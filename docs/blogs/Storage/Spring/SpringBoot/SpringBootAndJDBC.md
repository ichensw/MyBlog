...
![2](https://gitee.com/ichensw/drawing-bed/raw/master/image/2.png)
...
- 需要注意的是，这里我们并没有指定属性文件的地址，所以我们需要把jdbc.properties名称改为application.properties，这是SpringBoot默认读取的属性文件名：
  ...
  ![1](https://gitee.com/ichensw/drawing-bed/raw/master/image/1.png)
...
![4](https://gitee.com/ichensw/drawing-bed/raw/master/image/4.png)
...
![3](https://gitee.com/ichensw/drawing-bed/raw/master/image/3.png)
